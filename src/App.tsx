...
const TARIFF: Record<string, Record<number, Record<string, number>>> = {
  "INFORMAL": {
    ...
    21: {"SIN SEGURO":216,"CON SEGURO VIDA":220.5,"SEGURO VIDA + RUTA":225.8,"SEGURO VIDA + RUT + SOLIDARIO":240.6,"% RECAUDO":0.5,"MONTO_BASE":2500},
    ...
    15: {"SIN SEGURO":262,"CON SEGURO VIDA":266,"SEGURO VIDA + RUTA":272.4,"SEGURO VIDA + RUT + SOLIDARIO":285,"% RECAUDO":0.75,"MONTO_BASE":2500},
  ...
  "FORMAL/APP": {
    ...
    18: {"SIN SEGURO":417,"CON SEGURO VIDA":425.6,"SEGURO VIDA + RUTA":431.2,"SEGURO VIDA + RUT + SOLIDARIO":444.9,"% RECAUDO":0.75,"MONTO_BASE":4500},
